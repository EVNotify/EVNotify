<!-- Snackbar component -->
<template>
    <md-snackbar md-position="center" :md-active="active" :md-persistent="persistent" :md-duration="duration" :class="{'snackbar-error': error, 'snackbar-warning': warning}">
        <span>{{ text }}</span>
    </md-snackbar>
</template>
...
export default {
    ...
    methods: {
         ...
         * @param {String} type the type of message (warning or error) - if not set, default type will be used
