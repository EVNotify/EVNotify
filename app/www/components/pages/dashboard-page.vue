...
<script>
    ...
    import NIROEV39 from './../cars/NIRO_EV39.vue';
    ...
    export default {
        data() {
            return {
                ...
                obd2ErrorCount: 0,
                consumption: 0,
                supportedCars: ['IONIQ_BEV', 'IONIQ_HEV', 'IONIQ_PHEV', 'IONIQ_FL_EV', 'SOUL_EV', 'E_SOUL', 'AMPERA_E', 'BOLT_EV', 'KONA_EV', 'ZOE_Q210', 'NIRO_EV', 'NIRO_EV39'],
                initialized: false,
                translated: {},
