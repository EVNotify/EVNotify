                    ...
                    <md-ripple>
                        <md-card-header>
                            <div>
                                ...
                                <img v-if="station.verified && !station.fault_report" src="icons/verified.svg" class="status-icon">
                                <img v-if="station.fault_report" src="icons/error.svg" class="status-icon">
                                <img v-if="!station.fault_report && !station.verified" src="icons/unverified.svg" class="status-icon">
                            </div>
