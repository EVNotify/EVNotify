export default {
    ...
    BATTERY_CELL_VOLTAGE_MIN: 'Cell voltage (Min)',
    BATTERY_CELL_VOLTAGE_MAX: 'Cell voltage (Max)',
    BATTERY_CELL_VOLTAGE_DELTA: 'Cell voltage delta',
    BATTERY_CELL_VOLTAGE_SHORTS: 'Min / Max / Delta',
    BATTERY_FAN_SPEED: 'Battery fan speed',
    ODO: 'Odometer',
    ...
    CHARGING: 'Charging',
    SLOW_CHARGE_PORT: 'Slow charge port',
    NORMAL_CHARGE_PORT: 'Normal charge port',
    RAPID_CHARGE_PORT: 'Rapid charge port',
    ...
    BLUETOOTH_PERMISSION_REQUIRED: 'Nearby devices permission is required to list and connect to OBDII devices.',
    BLUETOOTH_PERMISSION_REQUEST: 'Request Bluetooth permission',
    ...
    DEBUG_DATA_DESCRIPTION: 'Latest decoded OBD frames captured on the dashboard.',
    DEBUG_DATA_EMPTY: 'No debug data captured yet.',
    DEBUG_COMMAND: 'Command',
    DEBUG_RAW_DATA: 'Raw data',
    DEBUG_INTERPRETED_DATA: 'Interpreted data',
    DEBUG_FIELD: 'Field',
    DEBUG_RAW: 'Raw',
    DEBUG_VALUE: 'Value',
